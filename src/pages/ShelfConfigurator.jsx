    ...
    <>
      <div className="flex flex-col md:flex-row h-[100dvh] relative">
        <div className="relative bg-gray-100 w-full md:w-[66%] h-[75%] md:h-full flex justify-center items-center">
          ...
          <div className="absolute top-[115px] lg:top-[75px] right-4 flex flex-row items-center gap-0 z-30 transition-top duration-200 pointer-events-none opacity-0 md:opacity-100 md:pointer-events-auto">
